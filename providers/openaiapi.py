...
def loadOmegaClawPlugin():
    ...
    # SNET — SingularityNet-hosted OpenAI-compatible endpoint (fork provider, carried across the
    # upstream plugin migration). Models via GET /v1/models; change `model=` at config to switch.
    plugin.registerLLMProvider("SNET", OpenAIAPIPreconfigured("SNET", "SNET_API_KEY", "openai/gpt-oss-120b", "https://llm.c.singularitynet.io/v1"))
